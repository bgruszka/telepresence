...
type InterceptSpec struct {
	...
	// HTTP header filters for Personal Intercepts. Only requests containing
	...
	// Path filter patterns for Personal Intercepts. Supports glob patterns like "/api/v1/*".
	...
	// Enable HTTP-aware interception mechanism for Personal Intercepts.

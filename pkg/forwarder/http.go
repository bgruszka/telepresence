...
func newHTTP(listenPort uint16, tag tunnel.Tag, targetHost string, targetPort uint16) Interceptor {
...
func (h *httpInterceptor) handleHTTPConn(clientConn net.Conn) error {
	...
	return h.forwardToOriginalService(ctx, clientConn, req, originalHost, originalPort)
}
...
func (h *httpInterceptor) rerouteHTTPConn(ctx context.Context, conn net.Conn, req *http.Request, clientSession tunnel.SessionID, dst netip.AddrPort, latency, timeout time.Duration) error {
...
func (h *httpInterceptor) forwardToOriginalService(ctx context.Context, clientConn net.Conn, req *http.Request, targetHost string, targetPort uint16) error {
	defer clientConn.Close()
